...
build_time_vars = {'ABIFLAGS': '',
 ...
 'CONFIG_ARGS': "'--enable-shared' '--prefix=/usr' "
                ...
                "'MKDIR_P=/bin/mkdir -p' 'CC=x86_64-linux-gnu-gcc' 'CFLAGS=-g "
                ' '
                '    '
                ' -fstack-protector-strong '
 ...
 'COREPYTHONPATH': '',
 'COVERAGE_INFO': '/build/python3.12-Qy6buT/python3.12-3.12.1/build-shared/coverage.info',
 'COVERAGE_LCOV_OPTIONS': '--rc lcov_branch_coverage=1',
 'COVERAGE_REPORT': '/build/python3.12-Qy6buT/python3.12-3.12.1/build-shared/lcov-report',
 ...
 'LIBHACL_CFLAGS': '-I../Modules/_hacl/include -D_BSD_SOURCE -D_DEFAULT_SOURCE '
                   ...
                   '-I../Include -Wdate-time -D_FORTIFY_SOURCE=2 -fPIC -fPIC',
 'LIBHACL_HEADERS': '\\',
 ...
 'MODBUILT_NAMES': '_bisect  _csv  _datetime  _heapq  _opcode  _pickle  '
                   ...
                   'grp  spwd  syslog  zlib  _asyncio  _contextvars  _json  '
                   '_lsprof  _queue  _xxsubinterpreters  _xxinterpchannels  '
                   '_zoneinfo  audioop  _decimal  _bz2  _lzma  _dbm  _gdbm  '
                   'readline  _codecs_cn  _codecs_hk  _codecs_iso2022  '
                   '_codecs_jp  _codecs_kr  _codecs_tw  _multibytecodec  '
                   '_crypt  mmap  nis  ossaudiodev  resource  termios  '
 ...
 'RETSIGTYPE': 'void',
 'RUNSHARED': 'LD_LIBRARY_PATH=/build/python3.12-Qy6buT/python3.12-3.12.1/build-shared',
 'SCRIPTDIR': '/usr/lib',
 ...
 'TESTOPTS': '',
 'TESTPATH': '',
 'TESTPYTHON': 'LD_LIBRARY_PATH=/build/python3.12-Qy6buT/python3.12-3.12.1/build-shared '
               './python -E',
 'TESTPYTHONOPTS': '',
 'TESTRUNNER': 'LD_LIBRARY_PATH=/build/python3.12-Qy6buT/python3.12-3.12.1/build-shared '
 ...
 'abs_builddir': '/build/python3.12-Qy6buT/python3.12-3.12.1/build-shared',
 'abs_srcdir': '/build/python3.12-Qy6buT/python3.12-3.12.1/build-shared/..',
