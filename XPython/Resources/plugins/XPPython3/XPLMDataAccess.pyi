...
from XPPython3.xp_typing import XPLMDataRef, XPLMDataRefInfo_t, XPLMDataTypeID
...
def registerDataAccessor(name: str, dataType: XPLMDataTypeID = Type_Unknown, writable: int = -1,
