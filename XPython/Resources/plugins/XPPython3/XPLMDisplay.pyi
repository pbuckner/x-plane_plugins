...
# (NoFlag is re-exported from the XPLMDefs C module: the 'as' form is what
#  mypy requires for a stub re-export, and pylint cannot see into the C module)
# (a stub's parameters are never used -- there is no body)
from typing import Union, Any, Callable, Optional, Sequence
from XPPython3.XPLMDefs import NoFlag as NoFlag
from XPPython3.xp_typing import (XPLMCursorStatus, XPLMKeyFlags, XPLMDeviceID, XPLMWindowContentType, XPLMMouseStatus,
                                 XPLMDrawingPhase, XPLMWindowLayer, XPLMWindowPositioningMode, XPLMWindowDecoration,
                                 XPLMAvionicsID, XPLMWindowID, XPLMHotKeyID, HotKeyInfo, XPLMObjectRef)
...
def unregisterDrawCallback(draw: Callable[[XPLMDrawingPhase, int, Any], None],
                           phase: XPLMDrawingPhase = Phase_Window, after: int = 0, refCon: Any = None) -> int:
    """
...
def createAvionicsEx(screenWidth: int = 100, screenHeight: int = 200, bezelWidth: int = 140, bezelHeight: int = 250,
                     ...
                     browserLoadError: Optional[Callable[[XPLMAvionicsID, str, str, Any], None]] = None,) -> XPLMAvionicsID:
    """
...
def createWindowEx(left: Union[int, Sequence[Any]] = 100, top: int = 200, right: int = 200, bottom: int = 100,
                   visible: int = 0,
                   ...
                   contentType: XPLMWindowContentType = WindowContentTypeOpenGL,
                   browserLoadFinished: Optional[Callable[[XPLMWindowID, str, Any], None]] = None,
                   browserLoadError: Optional[Callable[[XPLMWindowID, str, str, Any], None]] = None) -> XPLMWindowID:
    """
...
def windowAddBrowserFunction(windowID: XPLMWindowID, name: str,
                             function: Callable[[XPLMWindowID, str, Any], Optional[str]], refCon: Any = None) -> None:
    """
...
def avionicsAddBrowserFunction(avionicsID: XPLMAvionicsID, name: str,
                               function: Callable[[XPLMAvionicsID, str, Any], Optional[str]], refCon: Any = None) -> None:
    """
    Register a callback the browser page can invoke as `xplane.<name>(arg)`.
