...
from XPPython3.xp_typing import XPLMDrawingPhase, XPLMDeviceID, XPLMAvionicsID, XPLMKeyFlags, XPLMMouseStatus, XPLMCursorStatus, \
    XPLMWindowLayer, XPLMWindowPositioningMode, XPLMWindowDecoration, XPLMWindowID, XPLMHotKeyID, HotKeyInfo
NoFlag: XPLMKeyFlags
...
def registerDrawCallback(draw: Callable[[XPLMDrawingPhase, int, Any], None | int],
                         phase: XPLMDrawingPhase = xp.Phase_Window, after: int = 0, refCon: Any = None) -> int:
    """
...
def createWindowEx(left: int = 100, top: int = 200, right: int = 200, bottom: int = 100,
                   ...
                   refCon: Any = None, decoration: XPLMWindowDecoration = xp.WindowDecorationRoundRectangle,
                   layer: XPLMWindowLayer = xp.WindowLayerFloatingWindows,
...
def registerHotKey(vkey: int, flags: XPLMKeyFlags = xp.NoFlag, description: str = '',
...
def setHotKeyCombination(hotKeyID: XPLMHotKeyID, vKey: int, flags: XPLMKeyFlags = xp.NoFlag) -> None:
    """
