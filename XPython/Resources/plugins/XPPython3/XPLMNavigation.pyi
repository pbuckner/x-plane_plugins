...
from XPPython3.xp_typing import (FMSEntryInfo, NavAidInfo, XPLMNavFlightPlan,
                                 XPLMNavRef, XPLMNavType)
Nav_Any: XPLMNavType = XPLMNavType(0xffffffff)
...
def findNavAid(name: Optional[str] = None, navAidID: Optional[str] = None,
               lat: Optional[float] = None, lon: Optional[float] = None,
               freq: Optional[int] = None, navType: XPLMNavType = Nav_Any) -> XPLMNavRef:
    """
