...
def createFlightLoop(callback: Callable[[float, float, int, Any], float],
                     phase: XPLMFlightLoopPhaseType = xp.FlightLoop_Phase_BeforeFlightModel,
                     refCon: Any = None) -> XPLMFlightLoopID:
    """
...
def isFlightLoopValid(flightLoopID: XPLMFlightLoopID) -> int:
    ...
