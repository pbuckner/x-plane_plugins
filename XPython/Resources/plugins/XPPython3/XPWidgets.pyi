...
# (Mode_UpChain is re-exported from the XPWidgetDefs C module: the 'as' form is
#  what mypy requires for a stub re-export, and pylint cannot see into the C module)
from typing import Any, Callable, Literal, Optional
from XPPython3.XPWidgetDefs import Mode_UpChain as Mode_UpChain
from XPPython3.xp_typing import (XPDispatchMode, XPLMWindowID, XPWidgetClass,
