...
from XPPython3.imgui_typing import IMGUIStyle, IMGUIo, IMGUIContext, IMGUIDrawData, IMGUIDrawList, Vec2
...
def slider_int(label: str, value: int, min_value: int, max_value: int, format: str = "%.f", flags: int = 0) -> tuple[bool, int]: ...  # pylint: disable=redefined-builtin
def separator() -> None: ...
...
def end_child() -> None: ...
def get_window_draw_list() -> IMGUIDrawList: ...
