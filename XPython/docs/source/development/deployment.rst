...
Your options for packaging and depolying *your* plugin are:
...
Bundle your files into a zip-file and instruct your users to:

.. rst-class:: compact

#. Install XPPython3, and

#. Unzip your files into ``Resources/plugins/PythonPlugins``.
