...
See :doc:`xppythondicts`.

Internal XPPython3 datastructures are accessible to python plugins which may be helpful in your
debugging.
...
pylint. For this reason, we've included a set of ".pyi" stubs.
...
* :doc:`changesfromp2`
* :doc:`Porting from Python2 language <portingNotes>`
