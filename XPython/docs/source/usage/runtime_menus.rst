...
If all else fails, you can always re-download the zip file (mentioned in the :doc:`/usage/installation_plugin` page) and replace
...
Refreshes python sample plugins by downloading the latest set from github and
...
-------------------------
*pip* is a python-based installer that is commonly used to install
...
**Reload Scripts**
------------------
Stop / Reload / Restart all python plugins.
...
When step #3 **Reloaded** occurs, we search for all possible plugins, so if you add or delete
