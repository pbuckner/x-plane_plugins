...
{
  static char *keywords[] = {CHAR("fog"), CHAR("numberTexUnits"), CHAR("lighting"), CHAR("alphaTesting"), CHAR("alphaBlending"), CHAR("depthTesting"), CHAR("depthWriting"), nullptr};
  (void) self;
...
{
  static char *keywords[] = {CHAR("textureID"), CHAR("textureUnit"), nullptr};
  (void) self;
  int inTextureNum;
  int inTextureUnit;
...
{
  static char *keywords[] = {CHAR("idlist"), CHAR("count"), nullptr};
  (void) self;
  ...
  if(!PyArg_ParseTupleAndKeywords(args, kwargs, "Oi", keywords, &outTextureIds, &inCount)){
    PyErr_Clear();
    returnValues = 1;
    static char *nkeywords[] = {CHAR("count"), nullptr};
...
{
  static char *keywords[] = {CHAR("lat"), CHAR("lon"), CHAR("alt"), nullptr};
  (void) self;
  double inLatitude;
  double inLongitude;
...
{
  static char *keywords[] = {CHAR("x"), CHAR("y"), CHAR("z"), nullptr};
  (void) self;
  double inX;
  double inY;
  double inZ;
...
{
  static char *keywords[] = {CHAR("rgb"), CHAR("x"), CHAR("y"), CHAR("value"), CHAR("wordWrapWidth"), CHAR("fontID"), nullptr};
  (void) self;
...
{
  static char *keywords[] = {CHAR("rgb"), CHAR("x"), CHAR("y"), CHAR("value"), CHAR("digits"), CHAR("decimals"), CHAR("showSign"), CHAR("fontID"), nullptr};
  (void) self;
  PyObject *rgbList = Py_None;
  int inXOffset = 0;
  int inYOffset = 0;
...
{
  static char *keywords[] = {CHAR("textureID"), nullptr};
  (void) self;
  int inTextureID;
...
{
  static char *keywords[] = {CHAR("fontID"), CHAR("width"), CHAR("height"), CHAR("digitsOnly"), nullptr};
  (void) self;
  int inFontID;
  ...
  if(!PyArg_ParseTupleAndKeywords(args, kwargs, "iOOO", keywords, &inFontID, &outCharWidth, &outCharHeight, &outDigitsOnly)) {
    PyErr_Clear();
    returnValues = 1;
    static char *nkeywords[] = {CHAR("fontID"), nullptr};
...
{
  static char *keywords[] = {CHAR("fontID"), CHAR("string"), CHAR("numChars"), nullptr};
  (void) self;
  int inFontID;
  char *inChar;
  int inNumChars;
  ...
  if(!PyArg_ParseTupleAndKeywords(args, kwargs, "isi", keywords, &inFontID, &inChar, &inNumChars)) {
    PyErr_Clear();
    static char *nkeywords[] = {CHAR("fontID"), CHAR("string"), nullptr};
