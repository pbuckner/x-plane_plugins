...
// XPLM_440
PLUGIN_DLL(XPLMGetModifierKeys);
...
PLUGIN_DLL(XPLMAvionicsSetURL);
PLUGIN_DLL(XPLMAvionicsRefresh);
PLUGIN_DLL(XPLMAvionicsInjectScript);
PLUGIN_DLL(XPLMAvionicsAddBrowserFunction);
PLUGIN_DLL(XPLMSetObjectAvionics);
PLUGIN_DLL(XPLMClearObjectAvionics);
PLUGIN_DLL(XPLMCreateInstanceEx);
PLUGIN_DLL(XPLMInstanceSetCoordinateSpace);
PLUGIN_DLL(XPLMIsAvionicsMappedToVR);
PLUGIN_DLL(XPLMSetAvionicsMappedToVR);
PLUGIN_DLL(XPLMMakeColor);
PLUGIN_DLL(XPLMSetLineCap);
...
PLUGIN_DLL(XPLMScissorIntersect);
...
PLUGIN_DLL(XPLMMapDisplayProject);
PLUGIN_DLL(XPLMMapDisplayUnproject);
PLUGIN_DLL(XPLMMapDisplayScaleMeter);
PLUGIN_DLL(XPLMMapDisplayGetNorthHeading);
PLUGIN_DLL(XPLMMapDisplayGetTerrainAltitudes);
